...
def mode_16dle_manual_assist(allowed_words, max_guesses, entropy_cache_path, n_jobs):
    n_boards = 16
    ...
    while True:
        ...
        if guess_count >= max_guesses:
            print("\nReached max guesses (16dle would be lost)")
...
def main():
    ...
    mode_16dle_manual_assist(allowed, max_guesses, entropy_cache, n_jobs)
